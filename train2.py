...
X_train, X_test, y_train, y_test = train_test_split(dataset[
                                                        ['favorite_count', 'is_quote_status', 'retweet_count', 'source',
                                                         'text', 'hashtags', 'symbols', 'user_mentions', 'media']],
...
# RUN TRAINING
model = logistic_regression(joined_train, y_train, 1)
# model = naive_bayes(X_train, y_train, 1)
# model = svm(joined_train, y_train, 1)
# model = mlp(joined_train, y_train, 1)
